{ config, pkgs, lib, ... }:
{
  ...
  #home.file.".config/neovim/init.lua".source = ./src/config/nvim/init.lua;
  home.file.".local/share/applications/obsidian.desktop".source = ./src/local/share/applications/obsidian.desktop;
  ...
  # basic configuration of neovim please change to your own
